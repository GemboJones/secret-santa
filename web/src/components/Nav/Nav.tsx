...
const Nav = () => {
  ...
  return (
    <>
      <div className={`flex h-screen w-[460px] flex-col justify-between bg-supernova px-12 pb-12 pt-[160px] transition-transform duration-500 ${isHamburger ? '-translate-x-[120%]' : 'translate-x-0'}`}>
